		...
		storage.get(function(items) {
			...
			if (typeof(chrome) === 'undefined') {
				if (!items.isProperlyMigrated) {
					XKit.window.show("Storage migration in progress", "XKit is still busy copying your preferences from the old storage system to the new one. Please check back in a couple seconds by refreshing the page.", "warning",  "<div class=\"xkit-button default\" id=\"xkit-bridge-refresh\">Refresh</div>");
