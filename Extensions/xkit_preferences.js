...
XKit.extensions.xkit_preferences = new Object({
	...
	button_svgs: {
		...
		x: "<svg xmlns='http://www.w3.org/2000/svg' width='22' height='22' viewBox='0 0 88 88'><rect width='100%' height='100%' mask='url(#x-mask)' /><mask id='x-mask'><circle cx='50%' cy='50%' r='50%' fill='white' /><text x='50%' y='50%' font-size='64' lengthAdjust='spacingAndGlyphs' textLength='48' font-family='Favorit' text-anchor='middle' dominant-baseline='central' fill='black' stroke='black'>𝕏</text></mask></svg>"
	},
