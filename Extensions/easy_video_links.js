...
XKit.extensions.easy_video_links = new Object({
	...
	run: function() {
		...
		XKit.interface.create_control_button("xkit-easy-video-links-button", this.button_icon, "Copy Video Address", "");
		XKit.extensions.easy_video_links.init();
		XKit.post_listener.add("easy_video_links", XKit.extensions.easy_video_links.do);
		XKit.extensions.easy_video_links.do();
	},

	init: function() {

		$(document).on("click", ".xkit-easy-video-links-button", function(event) {
